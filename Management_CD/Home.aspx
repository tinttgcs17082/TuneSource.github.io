<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Management_CD.Home" %>
                                    ...
                                    <table class="auto-style8">
                                        ...
                                        <tr>
                                            <td class="auto-style11">
                                                <asp:LinkButton ID="lbnDetail" runat="server" CommandArgument='<%# Bind("Id") %>' CommandName="Details">View Detail</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                </em>&nbsp;
